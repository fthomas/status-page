...
object Item {
  ...
  /** An [[Item]] which wraps another [[Item]] but always returns [[Result.Ok Ok]] as result.
    *
    * This can be used to render the wrapped [[Item]] but ignoring its status for the overall
    * result.
    */
